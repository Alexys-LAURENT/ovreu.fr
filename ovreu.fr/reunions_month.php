...
<div class="navbar">
  <ul class="tabs group">   
	  ...
	  <li class="active"><a href="reunions_month.php">RÉUNIONS DU MOIS</a></li> 
...
<center>
<br>
<h3>LISTE DES REUNIONS CE MOIS CI : </h3>
<?php
$lesInterventions = $unControleur->selectAllInterventionsmonth();
